...
interface MixCloudInterface {
    ...
    fun getUserPlaylistCloudCasts(username: String, playlistSlug: String, page: Int): UserCloudCastResponse?

    fun getUserPlaylistCloudCasts(username: String, playlistSlug: String, limit: Int, page: Int): UserCloudCastResponse?
