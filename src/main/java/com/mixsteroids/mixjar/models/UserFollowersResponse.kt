...
data class UserFollowersResponse(
    ...
    constructor(userFollowersResponse: UserFollowersResponse?) : this(
        userFollowersResponse?.data, userFollowersResponse?.paging, userFollowersResponse?.name
    )

    constructor() : this(userFollowersResponse = UserFollowersResponse(null, null, null))
}
