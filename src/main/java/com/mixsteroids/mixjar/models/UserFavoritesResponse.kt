...
data class UserFavoritesResponse(
    ...
    constructor(userFavoritesResponse: UserFavoritesResponse?) : this(
        userFavoritesResponse?.data, userFavoritesResponse?.paging, userFavoritesResponse?.name
    )

    constructor() : this(userFavoritesResponse = UserFavoritesResponse(null, null, null))
}
