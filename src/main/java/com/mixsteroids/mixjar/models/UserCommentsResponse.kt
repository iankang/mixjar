...
data class UserCommentsResponse(
    ...
    constructor(userCommentsResponse: UserCommentsResponse?) : this(
        userCommentsResponse?.data, userCommentsResponse?.paging, userCommentsResponse?.name
    )

    constructor() : this(userCommentsResponse = UserCommentsResponse(null, null, null))
}
