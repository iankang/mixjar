...
data class UserCloudCastResponse(
    ...
    constructor(userCloudCastResponse: UserCloudCastResponse?) : this(
        userCloudCastResponse?.data, userCloudCastResponse?.paging, userCloudCastResponse?.name
    )

    constructor() : this(userCloudCastResponse = UserCloudCastResponse(null, null, null))
}
